...
public abstract class PlayerBehavior {
	 ...
	 * @param controller The Location of the next Target to move to
	 */
	 ...
	 * @param deltaT The time, that has passed since the last movement
	 */
	 ...
	 */
	protected void tryToEatNextCircle(){
		//Next Object
		Circle nextCircle = controller.getNearestObject(parent);
		
		//Bigger Circle eats smaller Circle, when half of the smaller circle is covered
	...
	protected void moveToNewPosition(){
		...
		Vector nextLocRel = Utility.nextStepTowards(parent.getLocation(), nextTarget);
